    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('admin', 'Admin'), ('factory_manager', 'Factory Manager'), ('distributor', 'Distributor'), (
                    'dealership', 'Dealership'), ('retail chain manager', 'Retail Chain Manager'), ('individual entrepreneur', 'Individual Entrepreneur')], default='user', max_length=30)),
